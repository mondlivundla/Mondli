...
if (wolfY == 1 and wolfX == 1):#if the coordinates of the wolf clashes with the coordinates of the player(hero) then start a loop
    wolfX = random.randint(0,2)
    wolfY = random.randint(0,2)
if (fireY and fireX == 1):#if the coordinates of the fire clash with the player(hero) then start a loop
    fireX = random.randint(0, 2)
    fireY = random.randint(0, 2)
    if (fireX == wolfX and fireX == wolfY):#also if the coordinates of fire clash with the wolf, start a loop
        fireX = random.randint(0, 2)
        fireY = random.randint(0, 2)
